    ...
    <>
      <div className="w-full bg-orangePink">
        <div className="mx-auto max-w-[1240px] px-8 py-5">
          ...
          <div className="font-semibold text-lg text-customorange text-center py-8 hover:text-green-600">
<Link to="/blog" className="inline-block border-b-2 border-customorange hover:border-green-600">
  More at our blog
</Link>
</div>
